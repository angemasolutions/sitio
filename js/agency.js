...
var NoiseButton = function (_PIXI$Application) {
    ...
    _createClass(NoiseButton, [{
        ...
        key: "addGraphics", value: function addGraphics() {
        ...
        key: "drawWaves", value: function drawWaves() {
        ...
        key: "loadTexture", value: function loadTexture(src) {
        ...
        key: "createTimeLine", value: function createTimeLine() {
            ...
            this.timeline = new TimelineMax({
                ...
                {x: 0}, "-=.2").to(this.noiseFilter.scale, 0.2, {x: 0, y: 0}, "-=.2");
        }
    }, {
        ...
        key: "debounce", value: function debounce(func, context, wait, immediate) {
